		...
		<MainPageContainer>
			<IntroContainer>
				<IntroTextContainer>
					...
					physical dossier, filled with prints of all collab pieces, a hand typed copy of each prose, and
					a handmade Hightop Hotel keycard NFC tag pairing the physical to its NFT counterpart.
				</IntroTextContainer>
