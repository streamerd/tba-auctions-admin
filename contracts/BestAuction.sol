...
contract BestAuction is Ownable, ReentrancyGuard {
    struct Auction {
    ...
    function placeBid(uint256 _auctionId) external payable nonReentrant {
        ...
        // If it's the first bid that beats the reserve price, set endTime and emit the CountdownStarted event
        ...
        if (auction.highestBid < msg.value) {
            ...
            (bool depositSuccess, ) = payable(address(this)).call{
                value: msg.value
            }("");
